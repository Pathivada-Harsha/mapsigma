...
import FounderPrinciples from "../components/Founder-Principles.js"
import FounderHero1 from "../components/Founder-Hero.js"
import FounderTimeline from "../components/Founder-Timeline1.js"
import FounderCulture from "../components/Founder-Culture.js"
import FounderLegacy from "../components/Founder-Legacy.js"
...
import Founder5 from "./../images/Founder/Founder5.jpeg"
import Founder6 from "./../images/Founder/Founder6.jpeg"
import Founder7 from "./../images/Founder/Founder7.jpeg"
import Founder8 from "./../images/Founder/Founder8.jpeg"
import Founder9 from "./../images/Founder/Founder9.jpeg"
...
export default function FounderContent() {
    ...
    const timelineEvents = [
        {
            year: "1976",
            title: "Born in Singapore",
            description: `Austin Prakesh was born in 1976 in Singapore to humble beginnings. 
    Raised by his mother Angel Janet Fernando, a devoted homemaker, and father Subramaniam, 
    a dedicated police officer, Austin grew up in a household that knew struggle, sacrifice, 
    and the value of holding a family together. With an older brother and an adopted younger sister, 
    he witnessed firsthand how strength doesn’t come from wealth but from unwavering love and resilience.`,
            image: Austin,
        },
        {
            year: "1990s",
            title: "Formative Years & Early Lessons",
            description: `As a teenager, Austin worked countless odd and physically demanding jobs. 
    He wasn’t chasing money but experience. Each role taught him about business building, people, 
    and pressure. Over time he developed a sharp instinct for reading human behavior by studying 
    body language and decision-making under stress. These years shaped him into a street-smart leader 
    with deep emotional intelligence and grit.`,
            image: Founder14,
        },
        {
            year: "1998-2000",
            title: "Service & Mentorship",
            description: `After serving in the Singapore Armed Forces, Austin met Stephen Tonrros and John Tidman, 
    who became pivotal mentors in his corporate journey. With their guidance, he entered hotel and tourism 
    corporate sales and rose rapidly through the ranks.`,
            image: Founder1,
        },
        {
            year: "2000-2009",
            title: "Corporate Leadership",
            description: `Between 2000 and 2009, Austin played a key role in managing and scaling businesses valued 
    at over 8 billion dollars. This period gave him strong foundations in business strategy, 
    operational leadership, and corporate growth.`,
            image: Founder7,
        },
        {
            year: "2011",
            title: "Zerodha – Angel Investor",
            description: `In early 2011, Austin moved to Bangalore, India, becoming an angel investor and Director 
    strategic advisor to Zerodha, founded by Nithin Kamath. He helped shape its early foundation, guiding 
    strategic growth, operations, and long-term vision. Austin also introduced the idea of financial 
    education for young Indians, believing in empowering the next generation through money management. 
    This later evolved into Rainmatter, Zerodha’s venture capital and incubation arm. Today, 
    Austin continues as Director of Strategy, shaping Zerodha as both a financial platform and 
    a purpose-driven movement.`,
        ...
        },
        {
            year: "2012",
            title: "Fitness Fight Club & Philanthropy",
            description: `Austin introduced white-collar boxing for corporate executives in Bangalore, through 
    Fitness Fight Club, co-founded with Nithin Kamath. Together, they also founded an NGO named Vs, 
    which helped fund heart surgeries for 228 children and supported education for over 22 children.`,
            image: Founder10,
        },
        {
            year: "2013",
    ...
    toward smarter, more reliable energy management systems.`,
        ...
        },
        {
            year: "2015",
            title: "Birth of Zia Austin",
            description: `In 2015, Austin’s life was blessed with the birth of his daughter, Zia. 
    Today, he is deeply involved in guiding her growth and instilling values of strength, compassion, and clarity.`,
            image: Founder2,
        },
        {
            year: "2015-2018",
            title: "Private Military Contractor",
            description: `Austin worked as a private military contractor in Warsaw, Poland, facing 
    the harsh realities of conflict. He witnessed loss and suffering, experiences that taught him the 
    priceless value of life, dignity, and peace.`,
            image: Founder11,
        },
        {
            year: "2022",
            title: "Skydiving Accident & Founding MAPSIGMA",
            description: `In 2022, a skydiving accident changed Austin’s life dramatically. Despite immense challenges, 
    he founded MAPSIGMA CAPITAL during his recovery, creating a firm built on values, trust, and generational 
    impact. MAPSIGMA was born not just to invest, but to leave a legacy rooted in family, purpose, and resilience.`,
            image: Founder8,
        },
        {
            year: "2023",
    ...
    transition to clean energy while creating jobs and fostering independence in rural and urban regions alike.`,
        ...
        },
        {
            year: "2024",
            title: "Resilience & Rebirth",
            description: `After enduring years of pain from his accident, Austin made the 
    courageous decision to amputate both legs in 2024. This was not an act of surrender, but a turning point 
    — fueling his mission to rise stronger, rebuild, and lead by example. His journey became a symbol of 
    possibility, purpose, and unshakable will.`,
            image: Founder13,
        },
    ]
            ...
            {/* <section className="founder-culture">
                <div className="culture-container">
                    ...
                    <div className="culture-image">
                        <img src="https://images.unsplash.com/photo-1560264280-88b68371db39?w=1200&h=800&fit=crop" alt="MAPSIGMA Culture" />
                    </div>
                </div>
            </section> */}
<FounderLegacy />
