  ...
  const articles = [
    {
      ...
      readTime: "8 min read",
      introduction: "In a world where market trends shift daily and noise dominates headlines, MAPSIGMA CAPITAL stands firm on a foundation that never wavers: principles.",
      sections: [
        {
          heading: "Why Principles Matter More Than Trends",
          content: "Markets evolve, but the fundamental laws governing them remain constant..."
        },
        {
          heading: "The Foundation of Our Investment Philosophy",
          content: "Our approach is built on three core pillars: Truth, Discipline, and Resilience..."
        },
        {
          heading: "How We Apply Principles to Portfolio Management",
          content: "Every portfolio we manage reflects our principled approach..."
        },
        {
          heading: "The Competitive Edge of Clarity",
          content: "In a world full of noise, clarity is power..."
        }
      ],
      keyTakeaways: [
      ...
      conclusion: "At MAPSIGMA CAPITAL, we don't follow trends—we follow truth."
    },
    {
      id: 2,
