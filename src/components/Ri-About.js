...
import service1 from "./..//images/Research&insights/ri4.png"
import service3 from "./../images/Research&insights/ri5.png"
      ...
      <div className="ri-about-container">
        <div className="ri-about-content">
          ...
          <div className={`ri-about-actions ${isVisible ? 'ri-about-animate' : ''}`}>
            <button className="ri-about-button">Explore Our Research</button>
